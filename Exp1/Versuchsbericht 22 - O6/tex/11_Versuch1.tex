...
\section{Durchführung}
	...
	\subsection{Aufnahmen mit dem Nikkor Objektiv}
		...
		Der Abstand der Kamera zu dem vertikalen Schirm betrug hierbei \SI{102}{\centi\meter}. % TODO Unsicherheit
	...
	\subsection{Aufnahmen mit der Einzellinse}
		...
		Für diesen Versuchsteil war der Abstand zwischen den Schirmen und der Kamera \SI{46,5}{\centi\meter}. % TODO Unsicherheit
		
\section{Datenanalyse} \label{sec:Analyse}
	
	\subsection{Schärfentiefe bei dem Nikkor Objektiv}
	
		% TODO subjektiv -> Höhe des scharfen Anteils b, Hypotenuse c

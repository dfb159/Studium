...
%	\setlength{\parindent}{0em} 
	...
	\section{Versuch 1: Strom-Spannungs-Charakteristik}
		...
		\subsection{b) Zenerdiode} %Erklärung Zenerdioden, Messung und Schlussfolgerung
			...
			Die Zenerdiode funktioniert wie die in \ref{Diode} beschriebene Diode, nur dass bei der Zenerdiode auch in Sperrrichtung Strom fließen kann, insofern die angelegte Spannung groß genug ist. %TODO warum
			
			\subsubsection{Messung}
			
				 \begin{itemize}
				 	\item in Sperrrichtung: In Abb. \ref{} erkennt man %TODO was
				 	\item in Durchlassrichtung: Wie in Abb. \ref{} dargestellt, verlief diese Messung analog zu der in \ref{a)} durchgeführten Messung.				 	
				\end{itemize}
				
			\subsubsection{Schlussfolgerung}
				
				Auch dieses Ergebnisse führen zu %TODO was

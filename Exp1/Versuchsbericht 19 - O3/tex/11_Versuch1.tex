\subsection{Teilversuch 1: Gesetz von Malus}
		...
		\subsubsection*{Datenanalyse}
			...
			Hinzu kommt der Faktor $k=0,994+-0,004$ vor der Drehung um den Winkel $\phi$, da auch ohne Einstrahlung des Laserlichts von außen eine geringfügige Spannung von \SI{3+-0,21}{\milli\volt} durch das Licht in dem Raum aufgenommen wurde. % TODO @Joey, passt das? oder hatte das einen anderen Grund

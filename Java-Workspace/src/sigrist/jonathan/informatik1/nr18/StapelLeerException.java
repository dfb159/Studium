...
/**
 * Die Klasse stellt eine erweiterte Exception zur Verfuegung, welche in der
 * Klasse Stapel geworfen werden kann.
 * 
...
public class StapelLeerException extends Exception {
	...
	/**
	 * Der Konstruktor erstellt eine neue Exception und fuegt eine leserliche
	 * Beschreibung hinzu.
	 */

...
public class Rad {
	 ...
	 * @param felge Die Felge des Rades.
	 * @param reifen Der Reifen des Rades.
	 */
	...
	public int getKosten() {
		...
		/*
		 * Methode gibt die Summe aller Teilkosten der, soweit vorhandenen Radteile aus.
		 * Falls eine Komponente null sein sollte, dann wird sie uebersprungen.
		 */
		
		return (felge!=null?felge.getKosten():0)
				+ (reifen!=null?reifen.getKosten():0);
	}
